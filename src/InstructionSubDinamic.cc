 ...
 * @since Feb 24 2026
 * @file InstructionSubDinamic.cc
 * @desc Implementación de la instrucción Sub para memoria dinámica.
 *
 */

#include "../lib/InstructionSubDinamic.h"

InstructionSubDinamic::InstructionSubDinamic(DataMemoryDinamic* data_memory)
    : data_memory_(data_memory) {}

void InstructionSubDinamic::execute(const InstructionContext& context) {
