 ...
 * @desc Implementación de la instrucción Sub para memoria estática.
 *
 */
...
InstructionSub::InstructionSub(DataMemory* data_memory) : data_memory_(data_memory) {}

void InstructionSub::execute(const InstructionContext& context) {
