 ...
 * @desc Implementación de la instrucción Div para memoria estática.
 *
 */
...
InstructionDiv::InstructionDiv(DataMemory* data_memory) : data_memory_(data_memory) {}

void InstructionDiv::execute(const InstructionContext& context) {
