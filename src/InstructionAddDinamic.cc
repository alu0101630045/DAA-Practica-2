 ...
 * @since Feb 24 2026
 * @file InstructionAddDinamic.cc
 * @desc Implementación de la instrucción Add para memoria dinámica.
 *
 */

#include "../lib/InstructionAddDinamic.h"

InstructionAddDinamic::InstructionAddDinamic(DataMemoryDinamic* data_memory)
    : data_memory_(data_memory) {}

void InstructionAddDinamic::execute(const InstructionContext& context) {
